...
layout: default
parent: Publications & More
grand_parent: For Researchers
nav_order: 2
redirect_from:
  - /caps-2025
  - /caps-2025.html
...
The [presentation]({{ '/assets/caps-2025-presentation-prooffrog.pdf' | relative_url }}) walked through the pen-and-paper proof that the KEM-DEM construction is IND-CPA-secure, then showed the analogous proof in ProofFrog.
